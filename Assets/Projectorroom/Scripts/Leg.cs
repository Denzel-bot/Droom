...
public class Leg : MonoBehaviour
{
    ...
    public float stepSize2 = 1f;
    public float stepSize3 = 1f;
    public float smoothness = 1;
    public float smoothness2= 1;
    public float smoothness3= 1;
    ...
    void FixedUpdate()
    {
        ...
        float maxDistance2 = stepSize2;
        float maxDistance3 = stepSize3;
        for (int i = 0; i < nbLegs; ++i)
        {
